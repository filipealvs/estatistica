...
# --- ESTUDO DE CASO 02: IDADE DOS ALUNOS
...
## --- ESTUDO DE CASO 03: Idade de bebes de uma padiatria
dados_idades_bebes = [0.2, 0.9, 0.4, 0.7, 0.1, 0.8, 0.3, 0.6, 0.5, 0.2, 1.0, 0.7, 0.3, 0.9, 0.5, 0.1, 0.8, 0.4, 0.6, 1.0, 0.2, 0.7, 0.5, 0.9, 0.3]
df_bebes = analisar_dados_estatisticos(dados_idades_bebes, "Idade de bebes de uma padiatria")
