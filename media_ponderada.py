...
porporcao_ativa_amostra = len(satisfacao_usuarios_ativos) / len(amostra_completa)
proporcao_ocasional_amostra = len(satisfacao_usuarios_ocasionais)/len(amostra_completa)
print(f"proporção usuários ativos na amostra: {porporcao_ativa_amostra}")
print(f"proporção usuários ocasionais na amostra: {proporcao_ocasional_amostra}")

peso_ativos_balanceados = proporcao_populacao_ativa / porporcao_ativa_amostra
peso_ocasionais_balanceado = proporcao_populacao_ocasional / proporcao_ocasional_amostra

array_pesos_ativos = [peso_ativos_balanceados] * len(satisfacao_usuarios_ativos)
